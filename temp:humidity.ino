...
static const u1_t PROGMEM DEVEUI[8] = { 0xFB, 0x1D, 0x06, 0xD0, 0x7E, 0xD5, 0xB3, 0x70 };
...
static const u1_t PROGMEM APPKEY[16] = { 0xC5, 0x97, 0xD1, 0x7E, 0x39, 0xC2, 0xEC, 0xD4, 0xCD, 0xC8, 0x82, 0xF0, 0xC7, 0xE7, 0x30, 0x50 };
...
void do_send(osjob_t* j) {
 ...
 Soil_val=analogRead(SoilSensor);//read values from analog pin A0 (SoilSensor)
  Soil_val = map(Soil_val,550,10,0,100);
  ...
  Serial.print("%");
    ...
    LMIC.frame[6]= Soil_val >> 8;
    LMIC.frame[7]=Soil_val;
